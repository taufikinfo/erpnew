...
from app.api.endpoints import auth, customers, employees, inventory, dashboard, sales, projects, docs, blogs, faqs, finance, profile, vendors, purchase_orders, manufacturing, users, system_settings, chat, tickets
